...
<head>
    ...
    <title>Pemberitahuan user baru</title>
    <style type="text/css">
                                        ...
                                        <tbody><tr>
                                            <td align="" style="color: #717f8c; font-size: 14px; font-family: 'Open Sans', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
                                                <div class="editable_text" style="line-height: 24px">
														<span class="text_container">
														<!-- ======= section text ======= -->
                                                        <p>Selamat datang di {{ config('app.name') }} berikut adalah detail user Anda</p>
                                                        <table class="table" width="100%">
                                                            <tr>
                                                                <th style="text-align: left" class="col-md-2">Nama Lengkap</th>
                                                                <td class="col-md-4">{{$user->name}}</td>
                                                            </tr>    
                                                            <tr>
                                                                <th style="text-align: left" class="col-md-2">User Name</th>
                                                                <td class="col-md-4">{{$user->username}}</td>
                                                            </tr>    
                                                            <tr>
                                                                <th style="text-align: left" class="col-md-2">Email</th>
                                                                <td class="col-md-4">{{$user->email}}</td>
                                                            </tr>    
                                                            <tr>
                                                                <th style="text-align: left" class="col-md-2">Password</th>
                                                                <td class="col-md-4">{{$passwd}}</td>
                                                            </tr>    
                                                        </table>
                                                        <p>Silakan login dan lakukan aktivasi user Anda di  <a href="{{route('home')}}">{{route('home')}}</a> </p>
                                                        </span>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tbody><tr>
                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Open Sans', sans-serif; line-height: 22px;">
                                    <div class="editable_text" style=" line-height: 22px;">
			        						<span class="text_container">
			            					<a href="{{route('home')}}" style="color: #ffffff; text-decoration: none;" class="text2_color">{{route('home')}}</a>
			        						</span>
                                    </div>
                                </td>
                            </tr>
