...
<head>
    ...
    <title>Pemberitahuan upload katalog baru</title>
    <style type="text/css">
                                ...
                                <td align="center" style="color: #3c3c3c; font-size: 27px; font-family: 'Open Sans', sans-serif; font-weight: 700; mso-line-height-rule: exactly; line-height: 30px;" class="title_color main-header">
                                    ...
                                    <div class="editable_text" style="line-height: 30px;">
											<span class="text_container">
				        						...
				        						<h2>Hallo Admin Web Repository</h2>
                                        ...
                                        <tbody><tr>
                                            <td align="" style="color: #717f8c; font-size: 14px; font-family: 'Open Sans', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
                                                <div class="editable_text" style="line-height: 24px">
														<span class="text_container">
														<!-- ======= section text ======= -->
                                                        <p>Baru saja {{$catalog->user->name}} mengunggah sebuah katalog di {{ config('app.name') }} dengan detail sebagai berikut </p>
                                                        ...
                                                        <p>Silakan review untuk meng-approve unggahan tesebut pada link <a href="{{route('catalogs.show',$catalog->id)}}">{{route('catalogs.show',$catalog->id)}}</a> </p>
                                                        </span>
                                                </div>
                                            </td>
                                        </tr>
